...
import { P as PLATFORM_CONFIG, g as getTrialByNctId, t as transformTrialData, a as getMockTrialByNctId, b as getMockTrials } from '../../../chunks/clinicalTrialsApi_DZ73K9si.mjs';
...
async function GET({ params }) {
  ...
  try {
    ...
    if (!trial) {
      console.log(`[API /trials/${nctId}] Looking in mock data...`);
...
}, "C:/Users/Jorge/Documents/javi/src/pages/api/trials/[nctId].astro", void 0);

const $$file = "C:/Users/Jorge/Documents/javi/src/pages/api/trials/[nctId].astro";
const $$url = "/api/trials/[nctId]";
